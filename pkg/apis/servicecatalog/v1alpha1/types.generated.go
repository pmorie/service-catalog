		...
		case "parameters":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decMapstringruntime_RawExtension((*map[string]pkg4_runtime.RawExtension)(yyv547), d)
				}
			}
		case "secretRef":
			if r.TryDecodeAsNil() {
...
func (x *BindingSpec) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decMapstringruntime_RawExtension((*map[string]pkg4_runtime.RawExtension)(yyv558), d)
		}
	}
	yyj554++
	if yyhl554 {
		...
		case "conditions":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decSliceBindingCondition((*[]BindingCondition)(yyv573), d)
				}
			}
		default:
...
func (x *BindingStatus) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSliceBindingCondition((*[]BindingCondition)(yyv576), d)
		}
	}
	for {
		yyj575++
...
func (x codecSelfer1234) decSliceBroker(v *[]Broker, d *codec1978.Decoder) {
	...
	yyv604 := *v
	yyh604, yyl604 := z.DecSliceHelperStart()
	var yyc604 bool
	if yyl604 == 0 {
		if yyv604 == nil {
			yyv604 = []Broker{}
			yyc604 = true
		} else if len(yyv604) != 0 {
			yyv604 = yyv604[:0]
			yyc604 = true
		}
	} else if yyl604 > 0 {
		var yyrr604, yyrl604 int
		var yyrt604 bool
		if yyl604 > cap(yyv604) {

			yyrg604 := len(yyv604) > 0
			yyv2604 := yyv604
			yyrl604, yyrt604 = z.DecInferLen(yyl604, z.DecBasicHandle().MaxInitLen, 344)
			if yyrt604 {
				if yyrl604 <= cap(yyv604) {
					yyv604 = yyv604[:yyrl604]
				} else {
					yyv604 = make([]Broker, yyrl604)
				}
			} else {
				yyv604 = make([]Broker, yyrl604)
			}
		...
		} else if yyl604 != len(yyv604) {
			yyv604 = yyv604[:yyl604]
			yyc604 = true
		}
		yyj604 := 0
		for ; yyj604 < yyrr604; yyj604++ {
			yyh604.ElemContainerState(yyj604)
			if r.TryDecodeAsNil() {
				yyv604[yyj604] = Broker{}
			} else {
				yyv605 := &yyv604[yyj604]
				yyv605.CodecDecodeSelf(d)
			}

		}
		if yyrt604 {
			for ; yyj604 < yyl604; yyj604++ {
				yyv604 = append(yyv604, Broker{})
				yyh604.ElemContainerState(yyj604)
				if r.TryDecodeAsNil() {
					yyv604[yyj604] = Broker{}
				} else {
					yyv606 := &yyv604[yyj604]
		...
		yyj604 := 0
		for ; !r.CheckBreak(); yyj604++ {

			if yyj604 >= len(yyv604) {
				yyv604 = append(yyv604, Broker{}) // var yyz604 Broker
				yyc604 = true
			}
			yyh604.ElemContainerState(yyj604)
			if yyj604 < len(yyv604) {
		...
		if yyj604 < len(yyv604) {
			yyv604 = yyv604[:yyj604]
			yyc604 = true
		} else if yyj604 == 0 && yyv604 == nil {
			yyv604 = []Broker{}
			yyc604 = true
		}
	}
...
func (x codecSelfer1234) decSliceBrokerCondition(v *[]BrokerCondition, d *codec1978.Decoder) {
	...
	yyv610 := *v
	yyh610, yyl610 := z.DecSliceHelperStart()
	var yyc610 bool
	if yyl610 == 0 {
		if yyv610 == nil {
			yyv610 = []BrokerCondition{}
			yyc610 = true
		} else if len(yyv610) != 0 {
			yyv610 = yyv610[:0]
			yyc610 = true
		}
	} else if yyl610 > 0 {
		var yyrr610, yyrl610 int
		var yyrt610 bool
		if yyl610 > cap(yyv610) {

			yyrg610 := len(yyv610) > 0
			yyv2610 := yyv610
			yyrl610, yyrt610 = z.DecInferLen(yyl610, z.DecBasicHandle().MaxInitLen, 64)
			if yyrt610 {
				if yyrl610 <= cap(yyv610) {
					yyv610 = yyv610[:yyrl610]
				} else {
					yyv610 = make([]BrokerCondition, yyrl610)
				}
			} else {
				yyv610 = make([]BrokerCondition, yyrl610)
			}
		...
		} else if yyl610 != len(yyv610) {
			yyv610 = yyv610[:yyl610]
			yyc610 = true
		}
		yyj610 := 0
		for ; yyj610 < yyrr610; yyj610++ {
			yyh610.ElemContainerState(yyj610)
			if r.TryDecodeAsNil() {
				yyv610[yyj610] = BrokerCondition{}
			} else {
				yyv611 := &yyv610[yyj610]
				yyv611.CodecDecodeSelf(d)
			}

		}
		if yyrt610 {
			for ; yyj610 < yyl610; yyj610++ {
				yyv610 = append(yyv610, BrokerCondition{})
				yyh610.ElemContainerState(yyj610)
				if r.TryDecodeAsNil() {
					yyv610[yyj610] = BrokerCondition{}
				} else {
					yyv612 := &yyv610[yyj610]
		...
		yyj610 := 0
		for ; !r.CheckBreak(); yyj610++ {

			if yyj610 >= len(yyv610) {
				yyv610 = append(yyv610, BrokerCondition{}) // var yyz610 BrokerCondition
				yyc610 = true
			}
			yyh610.ElemContainerState(yyj610)
			if yyj610 < len(yyv610) {
		...
		if yyj610 < len(yyv610) {
			yyv610 = yyv610[:yyj610]
			yyc610 = true
		} else if yyj610 == 0 && yyv610 == nil {
			yyv610 = []BrokerCondition{}
			yyc610 = true
		}
	}
...
func (x codecSelfer1234) decSliceServiceClass(v *[]ServiceClass, d *codec1978.Decoder) {
	...
	yyv616 := *v
	yyh616, yyl616 := z.DecSliceHelperStart()
	var yyc616 bool
	if yyl616 == 0 {
		if yyv616 == nil {
			yyv616 = []ServiceClass{}
			yyc616 = true
		} else if len(yyv616) != 0 {
			yyv616 = yyv616[:0]
			yyc616 = true
		}
	} else if yyl616 > 0 {
		var yyrr616, yyrl616 int
		var yyrt616 bool
		if yyl616 > cap(yyv616) {

			yyrg616 := len(yyv616) > 0
			yyv2616 := yyv616
			yyrl616, yyrt616 = z.DecInferLen(yyl616, z.DecBasicHandle().MaxInitLen, 480)
			if yyrt616 {
				if yyrl616 <= cap(yyv616) {
					yyv616 = yyv616[:yyrl616]
				} else {
					yyv616 = make([]ServiceClass, yyrl616)
				}
			} else {
				yyv616 = make([]ServiceClass, yyrl616)
			}
		...
		} else if yyl616 != len(yyv616) {
			yyv616 = yyv616[:yyl616]
			yyc616 = true
		}
		yyj616 := 0
		for ; yyj616 < yyrr616; yyj616++ {
			yyh616.ElemContainerState(yyj616)
			if r.TryDecodeAsNil() {
				yyv616[yyj616] = ServiceClass{}
			} else {
				yyv617 := &yyv616[yyj616]
				yyv617.CodecDecodeSelf(d)
			}

		}
		if yyrt616 {
			for ; yyj616 < yyl616; yyj616++ {
				yyv616 = append(yyv616, ServiceClass{})
				yyh616.ElemContainerState(yyj616)
				if r.TryDecodeAsNil() {
					yyv616[yyj616] = ServiceClass{}
				} else {
					yyv618 := &yyv616[yyj616]
		...
		yyj616 := 0
		for ; !r.CheckBreak(); yyj616++ {

			if yyj616 >= len(yyv616) {
				yyv616 = append(yyv616, ServiceClass{}) // var yyz616 ServiceClass
				yyc616 = true
			}
			yyh616.ElemContainerState(yyj616)
			if yyj616 < len(yyv616) {
		...
		if yyj616 < len(yyv616) {
			yyv616 = yyv616[:yyj616]
			yyc616 = true
		} else if yyj616 == 0 && yyv616 == nil {
			yyv616 = []ServiceClass{}
			yyc616 = true
		}
	}
...
func (x codecSelfer1234) decSliceServicePlan(v *[]ServicePlan, d *codec1978.Decoder) {
	...
	yyv622 := *v
	yyh622, yyl622 := z.DecSliceHelperStart()
	var yyc622 bool
	if yyl622 == 0 {
		if yyv622 == nil {
			yyv622 = []ServicePlan{}
			yyc622 = true
		} else if len(yyv622) != 0 {
			yyv622 = yyv622[:0]
			yyc622 = true
		}
	} else if yyl622 > 0 {
		var yyrr622, yyrl622 int
		var yyrt622 bool
		if yyl622 > cap(yyv622) {

			yyrg622 := len(yyv622) > 0
			yyv2622 := yyv622
			yyrl622, yyrt622 = z.DecInferLen(yyl622, z.DecBasicHandle().MaxInitLen, 80)
			if yyrt622 {
				if yyrl622 <= cap(yyv622) {
					yyv622 = yyv622[:yyrl622]
				} else {
					yyv622 = make([]ServicePlan, yyrl622)
				}
			} else {
				yyv622 = make([]ServicePlan, yyrl622)
			}
		...
		} else if yyl622 != len(yyv622) {
			yyv622 = yyv622[:yyl622]
			yyc622 = true
		}
		yyj622 := 0
		for ; yyj622 < yyrr622; yyj622++ {
			yyh622.ElemContainerState(yyj622)
			if r.TryDecodeAsNil() {
				yyv622[yyj622] = ServicePlan{}
			} else {
				yyv623 := &yyv622[yyj622]
				yyv623.CodecDecodeSelf(d)
			}

		}
		if yyrt622 {
			for ; yyj622 < yyl622; yyj622++ {
				yyv622 = append(yyv622, ServicePlan{})
				yyh622.ElemContainerState(yyj622)
				if r.TryDecodeAsNil() {
					yyv622[yyj622] = ServicePlan{}
				} else {
					yyv624 := &yyv622[yyj622]
		...
		yyj622 := 0
		for ; !r.CheckBreak(); yyj622++ {

			if yyj622 >= len(yyv622) {
				yyv622 = append(yyv622, ServicePlan{}) // var yyz622 ServicePlan
				yyc622 = true
			}
			yyh622.ElemContainerState(yyj622)
			if yyj622 < len(yyv622) {
		...
		if yyj622 < len(yyv622) {
			yyv622 = yyv622[:yyj622]
			yyc622 = true
		} else if yyj622 == 0 && yyv622 == nil {
			yyv622 = []ServicePlan{}
			yyc622 = true
		}
	}
...
func (x codecSelfer1234) decSliceInstance(v *[]Instance, d *codec1978.Decoder) {
	...
	yyv628 := *v
	yyh628, yyl628 := z.DecSliceHelperStart()
	var yyc628 bool
	if yyl628 == 0 {
		if yyv628 == nil {
			yyv628 = []Instance{}
			yyc628 = true
		} else if len(yyv628) != 0 {
			yyv628 = yyv628[:0]
			yyc628 = true
		}
	} else if yyl628 > 0 {
		var yyrr628, yyrl628 int
		var yyrt628 bool
		if yyl628 > cap(yyv628) {

			yyrg628 := len(yyv628) > 0
			yyv2628 := yyv628
			yyrl628, yyrt628 = z.DecInferLen(yyl628, z.DecBasicHandle().MaxInitLen, 464)
			if yyrt628 {
				if yyrl628 <= cap(yyv628) {
					yyv628 = yyv628[:yyrl628]
				} else {
					yyv628 = make([]Instance, yyrl628)
				}
			} else {
				yyv628 = make([]Instance, yyrl628)
			}
		...
		} else if yyl628 != len(yyv628) {
			yyv628 = yyv628[:yyl628]
			yyc628 = true
		}
		yyj628 := 0
		for ; yyj628 < yyrr628; yyj628++ {
			yyh628.ElemContainerState(yyj628)
			if r.TryDecodeAsNil() {
				yyv628[yyj628] = Instance{}
			} else {
				yyv629 := &yyv628[yyj628]
				yyv629.CodecDecodeSelf(d)
			}

		}
		if yyrt628 {
			for ; yyj628 < yyl628; yyj628++ {
				yyv628 = append(yyv628, Instance{})
				yyh628.ElemContainerState(yyj628)
				if r.TryDecodeAsNil() {
					yyv628[yyj628] = Instance{}
				} else {
					yyv630 := &yyv628[yyj628]
		...
		yyj628 := 0
		for ; !r.CheckBreak(); yyj628++ {

			if yyj628 >= len(yyv628) {
				yyv628 = append(yyv628, Instance{}) // var yyz628 Instance
				yyc628 = true
			}
			yyh628.ElemContainerState(yyj628)
			if yyj628 < len(yyv628) {
		...
		if yyj628 < len(yyv628) {
			yyv628 = yyv628[:yyj628]
			yyc628 = true
		} else if yyj628 == 0 && yyv628 == nil {
			yyv628 = []Instance{}
			yyc628 = true
		}
	}
...
func (x codecSelfer1234) encMapstringruntime_RawExtension(v map[string]pkg4_runtime.RawExtension, e *codec1978.Encoder) {
	...
	for yyk632, yyv632 := range v {
		z.EncSendContainerState(codecSelfer_containerMapKey1234)
		yym633 := z.EncBinary()
		_ = yym633
		if false {
		} else {
			r.EncodeString(codecSelferC_UTF81234, string(yyk632))
		}
		z.EncSendContainerState(codecSelfer_containerMapValue1234)
		yy634 := &yyv632
		yym635 := z.EncBinary()
		_ = yym635
		if false {
		} else if z.HasExtensions() && z.EncExt(yy634) {
		} else if !yym635 && z.IsJSONHandle() {
			z.EncJSONMarshal(yy634)
		} else {
			z.EncFallback(yy634)
		}
	}
...
func (x codecSelfer1234) decMapstringruntime_RawExtension(v *map[string]pkg4_runtime.RawExtension, d *codec1978.Decoder) {
	...
	yybh636 := z.DecBasicHandle()
	if yyv636 == nil {
		yyrl636, _ := z.DecInferLen(yyl636, yybh636.MaxInitLen, 56)
		yyv636 = make(map[string]pkg4_runtime.RawExtension, yyrl636)
		*v = yyv636
	}
	var yymk636 string
	var yymv636 pkg4_runtime.RawExtension
	var yymg636 bool
	if yybh636.MapValueReset {
		yymg636 = true
	}
	if yyl636 > 0 {
		for yyj636 := 0; yyj636 < yyl636; yyj636++ {
			z.DecSendContainerState(codecSelfer_containerMapKey1234)
			if r.TryDecodeAsNil() {
				yymk636 = ""
			} else {
				yymk636 = string(r.DecodeString())
			}

			if yymg636 {
				yymv636 = yyv636[yymk636]
			} else {
				yymv636 = pkg4_runtime.RawExtension{}
			}
			z.DecSendContainerState(codecSelfer_containerMapValue1234)
			if r.TryDecodeAsNil() {
				yymv636 = pkg4_runtime.RawExtension{}
			...
			if yyv636 != nil {
				yyv636[yymk636] = yymv636
			}
		}
	} else if yyl636 < 0 {
		for yyj636 := 0; !r.CheckBreak(); yyj636++ {
			z.DecSendContainerState(codecSelfer_containerMapKey1234)
			if r.TryDecodeAsNil() {
				yymk636 = ""
			} else {
...
func (x codecSelfer1234) decSliceInstanceCondition(v *[]InstanceCondition, d *codec1978.Decoder) {
	...
	if yyl645 == 0 {
		...
		if yyl645 > cap(yyv645) {
			...
			yyv2645 := yyv645
			yyrl645, yyrt645 = z.DecInferLen(yyl645, z.DecBasicHandle().MaxInitLen, 64)
			if yyrt645 {
				if yyrl645 <= cap(yyv645) {
					yyv645 = yyv645[:yyrl645]
				} else {
					yyv645 = make([]InstanceCondition, yyrl645)
				}
			} else {
				yyv645 = make([]InstanceCondition, yyrl645)
			}
		...
		for ; yyj645 < yyrr645; yyj645++ {
			...
			if r.TryDecodeAsNil() {
				yyv645[yyj645] = InstanceCondition{}
			} else {
		...
		if yyrt645 {
			for ; yyj645 < yyl645; yyj645++ {
				yyv645 = append(yyv645, InstanceCondition{})
				yyh645.ElemContainerState(yyj645)
				if r.TryDecodeAsNil() {
					yyv645[yyj645] = InstanceCondition{}
				} else {
		...
		for ; !r.CheckBreak(); yyj645++ {
			...
			if yyj645 >= len(yyv645) {
				yyv645 = append(yyv645, InstanceCondition{}) // var yyz645 InstanceCondition
				yyc645 = true
			}
			yyh645.ElemContainerState(yyj645)
			if yyj645 < len(yyv645) {
...
func (x codecSelfer1234) decSliceBinding(v *[]Binding, d *codec1978.Decoder) {
	...
	if yyl651 == 0 {
		...
		if yyl651 > cap(yyv651) {
			...
			yyv2651 := yyv651
			yyrl651, yyrt651 = z.DecInferLen(yyl651, z.DecBasicHandle().MaxInitLen, 512)
			if yyrt651 {
				if yyrl651 <= cap(yyv651) {
					yyv651 = yyv651[:yyrl651]
				} else {
					yyv651 = make([]Binding, yyrl651)
				}
			} else {
				yyv651 = make([]Binding, yyrl651)
			}
		...
		for ; !r.CheckBreak(); yyj651++ {
			...
			if yyj651 >= len(yyv651) {
				yyv651 = append(yyv651, Binding{}) // var yyz651 Binding
				yyc651 = true
			}
			yyh651.ElemContainerState(yyj651)
			if yyj651 < len(yyv651) {
...
func (x codecSelfer1234) decSliceBindingCondition(v *[]BindingCondition, d *codec1978.Decoder) {
	...
	if yyl657 == 0 {
		...
		if yyl657 > cap(yyv657) {
			...
			yyv2657 := yyv657
			yyrl657, yyrt657 = z.DecInferLen(yyl657, z.DecBasicHandle().MaxInitLen, 64)
			if yyrt657 {
				if yyrl657 <= cap(yyv657) {
					yyv657 = yyv657[:yyrl657]
				} else {
					yyv657 = make([]BindingCondition, yyrl657)
				}
			} else {
				yyv657 = make([]BindingCondition, yyrl657)
			}
		...
		for ; yyj657 < yyrr657; yyj657++ {
			...
			if r.TryDecodeAsNil() {
				yyv657[yyj657] = BindingCondition{}
			} else {
		...
		if yyrt657 {
			for ; yyj657 < yyl657; yyj657++ {
				yyv657 = append(yyv657, BindingCondition{})
				yyh657.ElemContainerState(yyj657)
				if r.TryDecodeAsNil() {
					yyv657[yyj657] = BindingCondition{}
				} else {
		...
		for ; !r.CheckBreak(); yyj657++ {
			...
			if yyj657 >= len(yyv657) {
				yyv657 = append(yyv657, BindingCondition{}) // var yyz657 BindingCondition
				yyc657 = true
			}
			yyh657.ElemContainerState(yyj657)
			if yyj657 < len(yyv657) {
